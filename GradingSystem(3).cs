            ...
            if (double.TryParse(input, out grade))
            {
                ...
                else
                {
                    ...
                    if (grade <= 100 && grade >= 99.0)
                    {
                        ...
                        description = " = 1.00 - Excellent";
                    }
                    else if (grade <= 98.9 && grade >= 96.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Green;
                        description = " = 1.25 - Excellent";
                    }
                    else if (grade <= 95.9 && grade >= 93.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Green;
                        description = " = 1.50 - Very Satisfactory";
                    }
                    else if (grade <= 92.9 && grade >= 90.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Green;
                        description = " = 1.75 - Very Satisfactory";
                    }
                    else if (grade <= 89.9 && grade >= 87.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Green;
                        description = " = 2.00 - Satisfactory";
                    }
                    else if (grade <= 86.9 && grade >= 84.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Green;
                        description = " = 2.25 - Satisfactory";
                    }
                    else if (grade <= 83.9 && grade >= 81.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Green;
                        description = " = 2.50 - Fairly Satisfactory";
                    }
                    else if (grade <= 80.9 && grade >= 78.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Red;
                        description = " = 2.75 - Fairly Satisfactory";
                    }
                    else if (grade <= 77.9 && grade >= 75.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Red;
                        description = " = 3.00 - Fairly Satisfactory";
                    }
                    else if (grade <= 74.9 && grade >= 70.0)
                    {
                        Console.WriteLine();
                        Console.ForegroundColor = ConsoleColor.Red;
                        description = " = 4.00 - Conditional Failure";
                    }
